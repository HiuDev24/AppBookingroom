...
void main() {
  runApp(HotelInfoPage1());
}

class HotelInfoPage1 extends StatefulWidget {
  @override
  _HotelInfoPageState1 createState() => _HotelInfoPageState1();
}

class _HotelInfoPageState1 extends State<HotelInfoPage1> {
                      ...
                      children: [
                        Padding(
                          padding: const EdgeInsets.only(
                            right:
                                130, // Khoảng cách từ bên phải của văn bản đến container
                          ),
                          child: Text(
                            '9.1 Tuyệt Vời',
                            style: TextStyle(
                        ...
                        Padding(
                          padding: const EdgeInsets.only(
                            right:
                                120, // Khoảng cách từ bên phải của văn bản đến container
                          ),
                          child: Text(
                        ...
                        Padding(
                          padding: const EdgeInsets.only(
                            right:
                                45, // Khoảng cách từ bên phải của văn bản đến container
                          ),
                          child: Text(
                            '40/14/ Bui Vien Street, \nWard Pham Ngu Lao,\nQuan 1 Disrtict,Ho Chi Minh City, \nQuận 1, Hồ Chí Minh, Việt Nam \n00000',
                            style: TextStyle(
                              fontSize: 12,
                              color: Colors.black54,
                            ),
                          ...
                          children: [
                            Padding(
                              ...
                              child: GestureDetector(
                                onTap: () {
                                  launch(
                                      'tel:+123456789'); // Thay số điện thoại bằng số muốn gọi
                                },
                                child: Icon(
                                  Icons.phone_android_outlined,
                                  color: Color.fromARGB(255, 6, 96, 241),
                                  size: 30,
                                ),
                              ),
                            ),
                              ...
                              child: ElevatedButton(
                                onPressed: () {
                                  ...
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                        builder: (context) => HotelInfoPage3()),
                                  );
                                },
                                style: ElevatedButton.styleFrom(
